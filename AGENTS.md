...
- Current release focus: `0.16.4` context observability and contextual metamemory (inspect explains match, rank/threshold attribution, and retrieval-level discrimination without changing retrieval behaviour)
